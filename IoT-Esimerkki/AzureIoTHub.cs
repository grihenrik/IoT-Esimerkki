...
class AzureIoTHub
{
    ...
    //
    // Note: this connection string is specific to the device "spr2k19". To configure other devices,
    // see information on iothub-explorer at http://aka.ms/iothubgetstartedVSCS
    //
    const string deviceConnectionString = "HostName=SovellusprojektiR2K19.azure-devices.net;DeviceId=spr2k19;SharedAccessKey=6EGxJVtYe7IwBa32+bwD+hwsHQbeHAY7hm8pxDliLZ0=";


    //
    // To monitor messages sent to device "kraaa" use iothub-explorer as follows:
    //    iothub-explorer monitor-events --login HostName=SovellusprojektiR2K19.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=q7cGFDs/PZhORTEjIF5bVdMdjsfXg4MZ7S9JczvwbTU= "spr2k19"
    //
    ...
    public static async Task SendDeviceToCloudMessageAsync(Measurement measurement)
    {
        CreateClient();
#if WINDOWS_UWP
        var str = "{\"deviceId\":\"spr2k19\",\"messageId\":1,\"text\":\"Hello, Cloud from a UWP C# app!\"}";
#else
        var str = "{\"deviceId\":\"spr2k19\",\"messageId\":1,\"text\":\"Hello, Cloud from a C# app!\"}";
#endif
        CreateClient();

        measurement.DeviceId = "spr2k19";

        str = JsonConvert.SerializeObject(measurement);
